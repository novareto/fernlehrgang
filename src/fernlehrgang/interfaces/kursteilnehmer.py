...
LIEFERSTOPPS = (('L1', u'UN-Modell anderer UV-Träger'),
                ...
                ('L7', u'TN nicht mehr im Unternehmen'),
                ('L8', u'UN nicht aktiv im Betriebsgeschehen'),
                ('L9', u'TN kein Unternehmer'),
...
#             ('G', u'zwischen 30 und 50'),
             ('G1', u'zwischen 30 und 50'),  # Achtung Neue Gruppe muss wieder raus
            ) 
